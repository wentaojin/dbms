...
func UpsertDataMigrate(serverAddr string, file string) error {
	...
	resp, err := openapi.Request(openapi.RequestPUTMethod, stringutil.StringBuilder(stringutil.WrapScheme(serverAddr, false), openapi.DBMSAPIBasePath, openapi.APITaskPath, "/", openapi.APIDataMigratePath), []byte(cfg.String()))
	if err != nil {
		return err
	}
...
func DeleteDataMigrate(serverAddr string, name string) error {
	resp, err := openapi.Request(openapi.RequestDELETEMethod, stringutil.StringBuilder(stringutil.WrapScheme(serverAddr, false), openapi.DBMSAPIBasePath, openapi.APITaskPath, "/", openapi.APIDataMigratePath), []byte(name))
	if err != nil {
		return err
	}
	var jsonData map[string]interface{}
...
func GetDataMigrate(serverAddr string, name string) error {
	resp, err := openapi.Request(openapi.RequestGETMethod, stringutil.StringBuilder(stringutil.WrapScheme(serverAddr, false), openapi.DBMSAPIBasePath, openapi.APITaskPath, "/", openapi.APIDataMigratePath), []byte(name))
	if err != nil {
		return err
	}
