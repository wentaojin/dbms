...
type IDatabaseDataCompare interface {
	...
	GetDatabaseTableSeekAbnormalData(querySQL string, queryArgs []interface{}, callTimeout int, chunkColumns []string, dbCharsetSli ...string) ([][]string, []map[string]string, error)
}
