...
func (siw *ServerInterfaceWrapper) APIDeleteAssessMigrate(c *gin.Context) {
	...
	siw.Handler.APIDeleteAssessMigrate(c)
}
...
func (siw *ServerInterfaceWrapper) APIListAssessMigrate(c *gin.Context) {
	...
	siw.Handler.APIListAssessMigrate(c)
}
...
func (siw *ServerInterfaceWrapper) APIDeleteDataScan(c *gin.Context) {
	...
	siw.Handler.APIDeleteDataScan(c)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.DELETE(options.BaseURL+"/task/dataScan", wrapper.APIDeleteDataScan)
	router.POST(options.BaseURL+"/task/dataScan", wrapper.APIListDataScan)
	router.PUT(options.BaseURL+"/task/dataScan", wrapper.APIPutDataScan)
